                        ...
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            ...
                            <form action="{{ route('admin.authenticate') }}" method="POST">
                                ...
                                <div class="row gy-3 overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button class="btn btn-xl btn-primary py-3" type="submit">Log in now</button>
                                        </div>
                                    </div>
                                    <div class="col-12 text-center mt-3">
                                        @if (Route::has('admin.password.request'))
                                        <a href="{{ route('admin.password.request') }}" class="link-secondary text-decoration-none">Forgot Password?</a>
                                        @endif
                                    </div>
                                </div>
                            </form>
